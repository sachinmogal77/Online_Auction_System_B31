    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='auction', to='seller_app.productinformation')),
            ],
        ),
        migrations.CreateModel(
            name='Bidders',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auction_autobids', to='auction_app.auctiondetails')),
                ('bidder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='autobids', to='auction_app.bidders')),
            ],
        ),
        migrations.CreateModel(
            name='AllBids',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bid_amount', models.FloatField()),
                ('auction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='allauctionbids', to='auction_app.auctiondetails')),
                ('bidder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='allbids', to='auction_app.bidders')),
            ],
        ),
    ]
