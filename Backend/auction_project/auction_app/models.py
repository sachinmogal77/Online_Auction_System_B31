...
class AuctionDetails(models.Model):
    ...
    def __str__(self) -> str:
        return f'{self.auction_id}---{self.product}---{self.auction_date}'
...
class CurrentAuctions(models.Model):
    ...
    def __str__(self) -> str:
        return f'{self.current_auction_id}----{self.auction}'
...
class Bidders(models.Model):
    ...
    def __str__(self) -> str:
        return f'{self.bidder_type}---{self.bidder}'
...
class AutomaticBidding(models.Model):
    ...
    def __str__(self) -> str:
        return f'{self.max_bid_amount}--{self.inc_amount}--{self.bidder}--{self.auction}'
...
class CurrentBids(models.Model):
    ...
    def __str__(self) -> str:
        return f'{self.bid_amount}---{self.bidder}---{self.auction}'
